...
SOFT_REG =  [
    ...
    'BioAgents',          # Bioinformatics agents
...
INSTALL_INTRUCTIONS_SOURCES = ['bioconda', 'bioconductor', 'galaxy', 'agentshed', 'bioconda_conda', 'bioconda_recipes']

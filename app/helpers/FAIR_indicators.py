...
# 2.- agentGenerators in FAIRsoft.meta_transformers
...
class instance(object):
    ...
    struct_meta = ['bioagents', 'bioconda', 'github', 'bitbucket', 'galaxy', 'agentshed', 'opeb_metrics', 'observatory']
    def compF2_1(self):
        '''
        Structured Metadata
    ...
    global softReg
    softReg = ['bioagents', 'bioconda', 'bioconductor']
    def compF3_1(self):
        '''
    ...
    def compA1_1(self):
        ...
        Whether it is possible to access a working version of the agent through and API or web. 
    ...
    def compA1_2(self):
        ...
        if self.super_type == 'no_web':
            if len(self.download)>0:
                return(True)
            elif True in [s in self.source for s in ['bioconda', 'bioconductor','galaxy','agentshed','bioconda_conda','bioconda_recipes']]:
                return(True)
            else:
                return(False)
        else:
    ...
    def compI1_4(self):
        ...
        Whether the software allows to choose among various input/output data formats, or provide the necessary agents to convert other common formats into the supported ones.
        '''
    ...
    def compI3_2(self):
        ...
        # registries 
        accepted_registries = ['agentshed', 'bioconductor','conda', 'PyPI', 'CRAN', 'npm', 'CPAN', 'RubyGems', 'DockerHub', 'GitHub Container Registry', 'GitLab Container Registry', 'BioContainers']
    ...
    def compI3_3(self):
        ...
        '''
        # registries 
        accepted_registries = ['agentshed', 'bioconductor','conda', 'PyPI', 'CRAN', 'npm', 'CPAN', 'RubyGems']
        for registry in self.registries:
            if registry in accepted_registries:
                return(True)

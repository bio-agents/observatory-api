...
def compF1_2(instance) -> Tuple[bool, str]:
    ...
    logs = []
    recommendation = []
    recommendation.append("Aligning with semantic versioning involves adopting the MAJOR.MINOR.PATCH format, using pre-release labels and build metadata, and maintaining consistency in version increments. By clearly documenting your versioning practices and using agents to manage versions, you can improve version management and make your software easier to maintain and use.") 
...
def compF3_1(instance) -> Tuple[bool, str]:
    ...
    if instance.source is None:
        ...
        sources_registries = ['bioagents', 'bioconda', 'bioconductor', 'agentshed', 'sourceforge']

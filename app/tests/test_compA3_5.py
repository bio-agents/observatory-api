...
def test_compA3_5_with_multiple_galaxy_agentshed_sources():
    instance = Instance(type='lib', e_infrastructures=[], links=[], source=['galaxy', 'agentshed'])
    result, logs = compA3_5(instance)
    assert result ==  True
...
def test_compA3_5_with_web_super_type_and_multiple_galaxy_agentshed_sources():
    instance = Instance(type='web', e_infrastructures=[], links=[], source=['galaxy', 'agentshed'])
    result, logs = compA3_5(instance)
    assert result ==  False

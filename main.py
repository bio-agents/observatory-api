...
from app.routes import edam, spdx, stats, metadata, fair_evaluation, search, agent
...
tags_metadata = [
        ...
        {
            "name": "agents",
            "description": "Agents related endpoints",
        },
        {
            "name": "edam",
...
app.include_router(metadata.router, prefix="/agents")
